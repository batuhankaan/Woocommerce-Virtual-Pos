...
class iParaPayment
{
    ...
    public function payThreeD()
    {
        ...
        $form .= "<html>";
        $form .= "<body>";
        $form .= "<form action=\"" . $this->three_d_url . "\" method=\"post\" id=\"three_d_form\"/>";
        $form .= "<input type=\"hidden\" name=\"orderId\" value=\"" . $this->order_id . "\"/>";
        $form .= "<input type=\"hidden\" name=\"amount\" value=\"" . number_format((float)$this->amount, 2, '', '') . "\"/>";
        $form .= "<input type=\"hidden\" name=\"cardOwnerName\" value=\"" . $this->card['owner_name'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"cardNumber\" value=\"" . $this->card['number'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"cardExpireMonth\" value=\"" . $this->card['expire_month'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"cardExpireYear\" value=\"" . $this->card['expire_year'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"installment\" value=\"" . $this->installment . "\"/>";
        $form .= "<input type=\"hidden\" name=\"cardCvc\" value=\"" . $this->card['cvc'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"mode\" value=\"" . $this->mode . "\"/>";
        $form .= "<input type=\"hidden\" name=\"purchaserName\" value=\"" . $this->purchaser['name'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"purchaserSurname\" value=\"" . $this->purchaser['surname'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"purchaserEmail\" value=\"" . $this->purchaser['email'] . "\"/>";
        $form .= "<input type=\"hidden\" name=\"successUrl\" value=\"" . $this->success_url . "\"/>";
        $form .= "<input type=\"hidden\" name=\"failureUrl\" value=\"" . $this->failure_url . "\"/>";
        $form .= "<input type=\"hidden\" name=\"echo\" value=\"" . $this->echo . "\"/>";
        $form .= "<input type=\"hidden\" name=\"version\" value=\"" . $this->version . "\"/>";
        $form .= "<input type=\"hidden\" name=\"transactionDate\" value=\"" . $timestamp . "\"/>";
