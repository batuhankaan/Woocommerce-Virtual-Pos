<?php
	...
	/**
         ...
         * @return bool
         */
        function CheckAndResolveMerchantData($merchantData, $bankData, $sign, $mac) {
         ...
         * @return bool
         */
        function ConnectAndDoTDSTransaction($merchantData,$bankData,$sign, $mac) {

            if (!$this->CheckSignForMercSite($merchantData, $bankData, $sign, $this->merchantInfo->enckey))
                return false;
