...
// const iframeDocument = document.getElementById("OM300x250").contentDocument
...
const inputMonth = document.getElementById("cc_expiry");
// const inputYears = document.getElementById("years");
// const closeX =  document.getElementById("close-x");
const htmlTr = document.getElementsByTagName("tr");
const inputCvc = document.getElementById("cc_cvc");
const inputName = document.getElementById("cc_name");
...
const iframeEvent = window.top.document.getElementById("iframesty");
const sppContent = document.getElementById("spp-content");
const date = new Date();
const topBody = window.top.document.documentElement;

//API İLE ÖDEME
// sppForm.onsubmit = function (e) {
//   e.preventDefault(); 
//     var data = {}, i = 0;

//     for (i; i < sppForm.length; ++i) {    
//       if (sppForm[i].name && sppForm[i].value) {
//         data[sppForm[i].name] = sppForm[i].value;
//        if(sppForm[i].checked){
//         sppForm[i].name.value = sppForm[i].value;
//            console.log("selected-var " + sppForm[i].value)
//            //BUG
//           //  cc_installment 12 gÃ¶nderiyor seÃ§ili olanÄ± gÃ¶ndereceÄŸiz
//            data[sppForm[i].name["cc_installment"]] = sppForm[i].value;
//        }
//         if(sppForm[2].value && sppForm[3].value){
//           const expiryMY = sppForm[2].value + '/' + sppForm[3].value;
//           data[sppForm[2].name] = expiryMY;
//         }
//       } 
//     }
//     var xhr = new XMLHttpRequest();
//     xhr.open(sppForm.method, sppForm.action, true);
...
//     sppContent.className="slide-out-elliptic-bottom-bck";
//     setTimeout(() => {
//       iframeEvent.style.display="none"
//     }, 1000);
//   });

//   tableShowButton.addEventListener('click', function () {
...
// getCORS(`${location.href}`, function(request){
