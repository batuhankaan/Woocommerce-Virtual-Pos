...
function bnToString(a) {
    ...
    if (g-- > 0)
        for (h < this.DB && (c = this[g] >> h) > 0 && (e = !0, f = int2char(c)); g >= 0;) h < b ? (c = (this[g] & (1 << h) - 1) << b - h, c |= this[--g] >> (h += this.DB - b)) : (c = this[g] >> (h -= b) & d, h <= 0 && (h += this.DB, --g)), c > 0 && (e = !0), e && (f += int2char(c));
    return e ? f : "0"
}
...
var superagentLegacyIESupportPlugin = function(a) {
        ...
        var c = function(a) {
            ...
            var e = this._query.join("&"),
                f = this._formData || this._data;
            if (this._callback = a || noop, d.onload = function() {
                    d.status = 200, c.emit("end")
                }, d.onerror = function() {
                    return d.status = 400, c.aborted ? c.timeoutError() : c.crossDomainError()
                }, d.onprogress = function() {
                    c.emit("progress", 50)
                }, d.ontimeout = function() {
                    return d.status = 408, c.timeoutError()
                }, e && (e = b(e), this.url += ~this.url.indexOf("?") ? "&" + e : "?" + e), "GET" != this.method && "POST" != this.method) throw "Only Get and Post methods are supported by XDomainRequest object.";
            return d.open(this.method, this.url, !0), "POST" == this.method && "string" != typeof f && (f = b(f)), this.emit("request", this), d.send(f), this
        };
        (function(a) {
            ...
            return b.href = a, {
                ...
                protocol: b.protocol,
                pathname: b.pathname,
                queryString: b.search
            }
        })(a.url).hostname != window.location.hostname && "undefined" != typeof XDomainRequest && (a.end = c)
    },
...
! function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [function(a, b, c) {
            function d(a) {
                return "[object Function]" === (e(a) ? Object.prototype.toString.call(a) : "")
            }
            var e = a("./is-object");
            b.exports = d
        }, {
        ...
        3: [function(a, b, c) {
            ...
            b.exports = d, d.prototype.clearTimeout = function() {
                ...
                return 0 !== arguments.length && !0 !== a || (a = 1), a <= 0 && (a = 0), this._maxRetries = a, this._retries = 0, this
                ...
                var b = f(a),
                    c = this._header["content-type"];
                if (this._formData && console.error(".send() can't be used if .attach() or .field() is used. Please use only .send() or only .field() & .attach()"), b && !this._data) Array.isArray(a) ? this._data = [] : this._isHost(a) || (this._data = {});
                else if (a && this._data && this._isHost(this._data)) throw Error("Can't merge these send calls");
                if (b && f(this._data))
                    for (var d in a) this._data[d] = a[d];
                else "string" == typeof a ? (c || this.type("form"), c = this._header["content-type"], this._data = "application/x-www-form-urlencoded" == c ? this._data ? this._data + "&" + a : a : (this._data || "") + a) : this._data = a;
        ...
        5: [function(a, b, c) {
            ...
            b.exports = function(a, b) {
                return !!(a && a.code && ~d.indexOf(a.code)) || (!!(b && b.status && b.status >= 500) || (!!(a && "timeout" in a && "ECONNABORTED" == a.code) || !!(a && "crossDomain" in a)))
            }
        }, {}],
        6: [function(a, b, c) {
            c.type = function(a) {
                ...
                return delete a["content-type"], delete a["content-length"], delete a["transfer-encoding"], delete a.host, b && delete a.cookie, a
            }
        }, {}],
        7: [function(a, b, c) {
            function d(a) {
        ...
        8: [function(a, b, c) {
            ...
            function f(a, b, c) {
                if (null != c)
                    if (Array.isArray(c)) c.forEach(function(c) {
                        f(a, b, c)
                    });
                    else if (p(c))
                    for (var d in c) f(a, b + "[" + d + "]", c[d]);
                else a.push(encodeURIComponent(b) + "=" + encodeURIComponent(c));
                else null === c && a.push(encodeURIComponent(b))
            }
            ...
            function h(a) {
                var b, c, d, e, f = a.split(/\r?\n/),
                    g = {};
                f.pop();
                for (var h = 0, i = f.length; h < i; ++h) c = f[h], b = c.indexOf(":"), d = c.slice(0, b).toLowerCase(), e = u(c.slice(b + 1)), g[d] = e;
                return g
            }
            ...
            function k(a, b) {
                ...
                this._query = this._query || [], this.method = a, this.url = b, this.header = {}, this._header = {}, this.on("end", function() {
                    ...
                    var d;
                    try {
                        c._isResponseOK(b) || (d = new Error(b.statusText || "Unsuccessful HTTP response"), d.original = a, d.response = b, d.status = b.status)
                    } catch (a) {
                        d = a
                    }
                    d ? c.callback(d, b) : c.callback(null, b)
                })
            }
            ...
            var u = "".trim ? function(a) {
                return a.trim()
            } : function(a) {
                return a.replace(/(^\s*|\s*$)/g, "")
            };
            t.serializeObject = e, t.parseString = g, t.types = {
                html: "text/html",
            ...
            }, r(j.prototype), j.prototype._parseBody = function(a) {
                var b = t.parse[this.type];
                return this.req._parser ? this.req._parser(this, a) : (!b && i(this.type) && (b = t.parse["application/json"]), b && a && (a.length || a instanceof Object) ? b(a) : null)
            }, j.prototype.toError = function() {
                var a = this.req,
                    b = a.method,
                    c = a.url,
                    d = "cannot " + b + " " + c + " (" + this.status + ")",
                    e = new Error(d);
                return e.status = this.status, e.method = b, e.url = c, e
            }, t.Response = j, n(k.prototype), o(k.prototype), k.prototype.type = function(a) {
                return this.set("Content-Type", t.types[a] || a), this
            }, k.prototype.accept = function(a) {
                return this.set("Accept", t.types[a] || a), this
            }, k.prototype.auth = function(a, b, c) {
                switch ("object" == typeof b && null !== b && (c = b), c || (c = {
                    type: "function" == typeof btoa ? "basic" : "auto"
                }), c.type) {
                    case "basic":
                        this.set("Authorization", "Basic " + btoa(a + ":" + b));
                        break;
                    case "auto":
                ...
                if (this._maxRetries && this._retries++ < this._maxRetries && s(a, b)) return this._retry();
            ...
            }, k.prototype._appendQueryString = function() {
                var a = this._query.join("&");
                if (a && (this.url += (this.url.indexOf("?") >= 0 ? "&" : "?") + a), this._sort) {
                    var b = this.url.indexOf("?");
                    if (b >= 0) {
                        var c = this.url.substring(b + 1).split("&");
                        q(this._sort) ? c.sort(this._sort) : c.sort(), this.url = this.url.substring(0, b) + "?" + c.join("&")
                    }
                }
                ...
                return this._endCalled && console.warn("Warning: .end() was called twice. This is not supported in superagent"), this._endCalled = !0, this._callback = a || d, this._appendQueryString(), this._end()
                ...
                if (this._withCredentials && (b.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof c && !this._isHost(c)) {
                    var e = this._header["content-type"],
                        f = this._serializer || t.serialize[e ? e.split(";")[0] : ""];
                    !f && i(e) && (f = t.serialize["application/json"]), f && (c = f(c))
                }
            ...
            }, t.head = function(a, b, c) {
                var d = t("HEAD", a);
                return "function" == typeof b && (c = b, b = null), b && d.send(b), c && d.end(c), d
            }, t.options = function(a, b, c) {
                var d = t("OPTIONS", a);
                return "function" == typeof b && (c = b, b = null), b && d.send(b), c && d.end(c), d
            }, t.del = l, t.delete = l, t.patch = function(a, b, c) {
                var d = t("PATCH", a);
                return "function" == typeof b && (c = b, b = null), b && d.send(b), c && d.end(c), d
            }, t.post = function(a, b, c) {
                var d = t("POST", a);
                return "function" == typeof b && (c = b, b = null), b && d.send(b), c && d.end(c), d
            }, t.put = function(a, b, c) {
                var d = t("PUT", a);
                return "function" == typeof b && (c = b, b = null), b && d.send(b), c && d.end(c), d
            }
        }, {
...
function() {
    var a = superagent,
        b = superagentLegacyIESupportPlugin,
        c = "https://test.masterpassturkiye.com/MasterpassJsonServerHandler/v2",
        d = "",
        e = new RSAKey;
    e.setPublic("", "03"), this.MFS = function() {
        var f, g, h, i = {
            ...
            l = function(a, b) {
                for (var c = a.find("input"), d = c.length - 1; d >= 0; d--) {
                    var f = c[d].getAttribute("type");
                    if (c[d].getAttribute("name") == b) {
                        if ("cardAliasName" == b || "accountAliasName" == b || "cardHolderName" == b || "listAccountName" == b) return encodeURIComponent(c[d].value);
                        if ("validationCode" == b && j) return e.encrypt(c[d].value);
                        if ("rtaPan" == b) return k(c[d].value) ? e.encrypt(c[d].value) : "";
                        if ("cvv" == b || "cvc" == b) return 3 != c[d].value.length && 4 != c[d].value.length ? "" : e.encrypt(c[d].value);
                        if ("installmentCount" == b && "" !== c[d].value && !isNaN(c[d].value)) return parseFloat(c[d].value);
                        if ("checkbox" == f || "radio" == f) {
                            if (!c[d].checked) continue
                        }
                        return c[d].value
                    }
                }
            ...
            m = function(a, b, c) {
                ...
                b.fp = d, b.additionalParams = h
            },
            n = function(a) {
                var b = JSON.parse(a.text || {}),
                    c = {};
                if (b.hasOwnProperty("Data")) {
                    c.referenceNo = b.Data.Body.Fault.Detail.ServiceFaultDetail.RefNo, c.responseCode = b.Data.Body.Fault.Detail.ServiceFaultDetail.ResponseCode, c.responseDescription = b.Data.Body.Fault.Detail.ServiceFaultDetail.ResponseDesc, c.url3D = b.Data.Body.Fault.Detail.ServiceFaultDetail.Url3D, c.url3DSuccess = b.Data.Body.Fault.Detail.ServiceFaultDetail.Url3DSuccess, c.url3DError = b.Data.Body.Fault.Detail.ServiceFaultDetail.Url3DError, c.newMsisdn = b.Data.Body.Fault.Detail.ServiceFaultDetail.NewMsisdn;
                    var d = b.Data.Body.Fault.Detail.ServiceFaultDetail.Token,
                        e = "";
                    if (b.Data.Body.hasOwnProperty("Response")) {
                        e = b.Data.Body.Response.Result.TransactionBody.Token, c.token = e;
                        var f = "";
                        b.Data.Body.Response.Result.TransactionBody.hasOwnProperty("RefNo") && "" !== b.Data.Body.Response.Result.TransactionBody.RefNo && (f = b.Data.Body.Response.Result.TransactionBody.RefNo), b.Data.Body.Fault.Detail.ServiceFaultDetail.hasOwnProperty("RefNo") && "" !== b.Data.Body.Fault.Detail.ServiceFaultDetail.RefNo && (f = b.Data.Body.Fault.Detail.ServiceFaultDetail.RefNo), c.transactionId = f;
                        var h = b.Data.Body.Response.Result.TransactionBody.ListItems;
                        try {
                            h && 0 !== h.ListItem && (c.cards = h.ListItem)
                        } catch (a) {}
                        c.accountStatus = b.Data.Body.Response.Result.TransactionBody.AccountStatus
                    }
                    d && 0 !== d.length ? g = d : c.token = e
                }
                return c
            },
            o = function(d, e, g) {
                ...
                h = h.replace(/"/g, ""), d.dateTime = h, d.version = "34", d.clientType = "1", a.post(c + e).use(b).send(JSON.stringify(d)).end(function(a, b) {
                    var c = n(b);
                    g(b.status, c)
                })
            },
            p = function(a, b) {
                var c = {};
                m(a, c, i.purchase), o(c, "/remotePurchaseOther", b)
            },
            q = function(a, b) {
                var c = {};
                m(a, c, i.registerCard), o(c, "/register", b)
            },
            r = function(a, b) {
                var c = {};
                m(a, c, i.deleteCard), o(c, "/deleteCard", b)
            },
            s = function(a, b) {
                var c = {};
                m(a, c, i.updateUser), o(c, "/updateUser", b)
            },
            t = function(a, b) {
                var c = {};
                m(a, c, i.forgotPassword), o(c, "/forgotPassword", b)
            },
            u = function(a, b) {
                var c = {};
                m(a, c, i.checkMasterPass), o(c, "/checkMasterPassEndUser", b)
            },
            v = function(a, b) {
                var c = {};
                m(a, c, i.addCardToMasterPass), o(c, "/addCardToMasterPass", b)
            },
            w = function(a, b) {
                var c = {};
                m(a, c, i.linkCardToClient), o(c, "/linkCardToClient", b)
            },
            x = function(a) {
                var b = {};
                b.referenceNo = "00000000", b.sendSms = "N", b.sendSmsLanguage = "eng", b.token = a, o(b, "/commitTransaction", function() {})
            },
            y = function(a, b) {
                var c = a.find("input[name^='pinType']")[0];
                j = "mpin" == c.value;
                var d = {};
                d.validationRefNo = g, m(a, d, i.validateTransaction), o(d, "/validateTransaction", b)
            },
            z = function(a, b) {
                var c = {};
                c.validationRefNo = g, m(a, c, i.purchaseAndRegister), o(c, "/purchaseAndRegister", b)
            },
            A = function(a, b, c) {
                var d = {};
                d.token2 = b, m(a, d, i.completeRegistration), o(d, "/completeRegistration", c)
            },
            B = function(a, b, c) {
                var d = {};
                d.msisdn = a, d.token = b, d.referenceNo = "00000000", d.listType = "ACCOUNT", d.sendSms = "Y", d.clientIp = "", d.sendSmsLanguage = "eng", o(d, "/listManagement", c)
            },
            C = function(a, b, c) {
                var d = {};
                d.validationRefNo = a, d.referenceNo = "00000000", d.sendSms = "N", d.sendSmsLanguage = b, o(d, "/resendOtp", c)
            },
            D = function(a, b) {
                var c = {};
                m(a, c, i.directPurchase), o(c, "/directPurchase", b)
            },
            E = function(a, b) {
                var c = {};
                m(a, c, i.verifyPin), o(c, "/verifyPin", b)
            },
            F = function(a) {
                f = a
            },
        ...
        return {
            ...
            commit: x,
            deleteCard: r,
            validateTransaction: y,
            forgotPassword: t,
            setAddress: G,
            checkMasterPass: u,
            linkCardToClient: w,
            addCardToMasterPass: v,
            purchaseAndRegister: z,
            directPurchase: D,
            resendOtp: C,
            completeRegistration: A,
            setFingerprint: H,
            setToken: function(a) {
                g = a
            },
