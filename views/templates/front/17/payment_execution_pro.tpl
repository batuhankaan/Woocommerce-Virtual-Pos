...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" crossorigin="anonymous"></script>
	...
	<div class="tx_banka" style="display:none" id="tx_banka_{$fam}">
		<select class="cc_installment_select input-lg cc_input form-control" name="cc_installment" id="tx_inst_{$fam}">
    ...
    <div class="tx_banka" style="display:none" id="tx_banka_all">
        <select class="cc_installment_select input-lg cc_input form-control" name="cc_installment" id="tx_inst_all">
